(function ($) {
  ...
  var $html = $("html"),
    ...
    $fixedHeaderPosition = $fixedHeader.elExists()
      ? $fixedHeader.offset().top
      : "",
    $fixedHeaderHeight = $fixedHeader.elExists()
  ...
  $offcanvasNavSubMenu
    .parent()
    .prepend(
      '<span class="menu-expand"><i class="la la-angle-down"></i></span>'
    );
  ...
  videoPopup.magnificPopup({
    type: "iframe",
    closeMarkup:
      '<button type="button" class="custom-close mfp-close"><i class="la la-remove"></i></button type="button">',
  });
